...
def generate_gexf(G, encoding: str = ..., prettyprint: bool = ..., version: str = ...) -> Generator[Incomplete, Incomplete, None]:
    ...
...
class GEXFWriter(GEXF):
    ...
    attr: Incomplete
    def __init__(self, graph: Incomplete | None = ..., encoding: str = ..., prettyprint: bool = ..., version: str = ...) -> None:
        ...
