...
def generate_graphml(G, encoding: str = ..., prettyprint: bool = ..., named_key_ids: bool = ..., edge_id_from_attribute: Incomplete | None = ...) -> Generator[Incomplete, Incomplete, None]:
    ...
...
class GraphMLWriter(GraphML):
    ...
    def __init__(self, graph: Incomplete | None = ..., encoding: str = ..., prettyprint: bool = ..., infer_numeric_types: bool = ..., named_key_ids: bool = ..., edge_id_from_attribute: Incomplete | None = ...) -> None:
        ...
...
class GraphMLReader(GraphML):
    ...
    edge_ids: Incomplete
    def __init__(self, node_type=..., edge_key_type=..., force_multigraph: bool = ...) -> None:
        ...
    
    xml: Incomplete
    def __call__(self, path: Incomplete | None = ..., string: Incomplete | None = ...) -> Generator[Incomplete, None, None]:
        ...
