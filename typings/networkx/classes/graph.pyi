...
_NodeWithData: TypeAlias = ...
_NodePlus: TypeAlias = ...
_Edge: TypeAlias = ...
_EdgeWithData: TypeAlias = ...
_EdgePlus: TypeAlias = ...
_MapFactory: TypeAlias = ...
_NBunch: TypeAlias = ...
_Data: TypeAlias = ...
class Graph(Collection[_Node]):
    ...
    def __init__(self, incoming_graph_data: _Data[_Node] | None = ..., **attr) -> None:
        ...
    ...
    def add_weighted_edges_from(self, ebunch_to_add: Iterable[tuple[_Node, _Node, Incomplete]], weight: str = ..., **attr: Incomplete) -> None:
        ...
    ...
    @overload
    def update(self, edges: Graph[_Node], nodes: None = ...) -> None:
        ...
    
    @overload
    def update(self, edges: Graph[_Node] | Iterable[_EdgePlus[_Node]] | None = ..., nodes: Iterable[_Node] | None = ...) -> None:
        ...
    ...
    def nbunch_iter(self, nbunch: _NBunch[_Node] = ...) -> Iterator[_Node]:
        ...
