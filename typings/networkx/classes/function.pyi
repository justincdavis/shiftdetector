...
@overload
def set_node_attributes(G: Graph[_Node], values: SupportsItems[_Node, SupportsKeysAndGetItem[Incomplete, Incomplete] | Iterable[tuple[Incomplete, Incomplete]]], name: None = ...) -> None:
    ...
...
def is_weighted(G: Graph[_Node], edge: tuple[_Node, _Node] | None = ..., weight: str = ...) -> bool:
    ...

def is_negatively_weighted(G: Graph[_Node], edge: tuple[_Node, _Node] | None = ..., weight: str = ...):
    ...
...
@overload
def selfloop_edges(G: Graph[_Node], data: Literal[False] = ..., keys: Literal[False] = ..., default=...) -> Generator[tuple[_Node, _Node], None, None]:
    ...

@overload
def selfloop_edges(G: Graph[_Node], data: Literal[True], keys: Literal[False] = ..., default=...) -> Generator[tuple[_Node, _Node, dict[str, Incomplete]], None, None]:
    ...

@overload
def selfloop_edges(G: Graph[_Node], data: str, keys: Literal[False] = ..., default: _U | None = ...) -> Generator[tuple[_Node, _Node, _U], None, None]:
    ...

@overload
def selfloop_edges(G: Graph[_Node], data: Literal[False], keys: Literal[True], default=...) -> Generator[tuple[_Node, _Node, int], None, None]:
    ...
...
@overload
def selfloop_edges(G: Graph[_Node], data: Literal[True], keys: Literal[True], default=...) -> Generator[tuple[_Node, _Node, int, dict[str, Incomplete]], None, None]:
    ...

@overload
def selfloop_edges(G: Graph[_Node], data: str, keys: Literal[True], default: _U | None = ...) -> Generator[tuple[_Node, _Node, int, _U], None, None]:
    ...
