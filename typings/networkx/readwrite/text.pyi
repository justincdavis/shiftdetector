...
def generate_network_text(graph, with_labels: bool = ..., sources: Incomplete | None = ..., max_depth: Incomplete | None = ..., ascii_only: bool = ...) -> Generator[Incomplete, None, Incomplete]:
    ...

def write_network_text(graph, path: Incomplete | None = ..., with_labels: bool = ..., sources: Incomplete | None = ..., max_depth: Incomplete | None = ..., ascii_only: bool = ..., end: str = ...) -> None:
    ...
